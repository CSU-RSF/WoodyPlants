...
namespace PortableApp
{
    ...
    public class WoodySearchRepository : DBConnection
	{
        ...
        public void SeedDB()
        {
            conn.Insert(new WoodySearch() { Characteristic = "PlantType-Deciduous", Name = "Deciduous", Query = false, Column1 = "family", SearchString1 = "Pine", SearchString2 = "Cypress", SearchString3 = "Grape", SearchString4 = "Buttercup", SearchString5 = "Cactus", SearchString6 = "null", IconFileName = "Deciduous.jpg" });
            ...
            conn.Insert(new WoodySearch() { Characteristic = "PlantType-Vine", Name = "Vine", Query = false, Column1 = "family", SearchString1 = "Grape", SearchString2 = "Buttercup", SearchString3 = "null", SearchString4 = "null", SearchString5 = "null", SearchString6 = "null", IconFileName = "Vine.jpg" });
            ...
            //TESTING SWITCHING LEAFSHAPE TO LEAF TYPE***********************************************************
            //conn.Insert(new WoodySearch() { Characteristic = "LeafShape-Narrow", Name = "Narrow", Query = false, Column1 = "leafType", SearchString1 = "narrow", SearchString2 = "linear", SearchString3 = "lanceolate", SearchString4 = "oblong", SearchString5 = "elliptic", SearchString6 = "oval", IconFileName = "narrow.png" });
            //conn.Insert(new WoodySearch() { Characteristic = "LeafShape-Deltoid", Name = "Deltoid", Query = false, Column1 = "leafType", SearchString1 = "deltoid", SearchString2 = "ovate", SearchString3 = "triangular", SearchString4 = "cordate", SearchString5 = "null", SearchString6 = "null", IconFileName = "Deltoid.jpg" });
            //conn.Insert(new WoodySearch() { Characteristic = "LeafShape-Orbicular", Name = "Orbicular", Query = false, Column1 = "leafType", SearchString1 = "orbicular", SearchString2 = "reniform", SearchString3 = "null", SearchString4 = "null", SearchString5 = "null", SearchString6 = "null", IconFileName = "Orbicular.jpg" });
            //conn.Insert(new WoodySearch() { Characteristic = "LeafShape-Oblanceolate", Name = "Oblanceolate", Query = false, Column1 = "leafType", SearchString1 = "oblanceolate", SearchString2 = "obovate", SearchString3 = "spatulate", SearchString4 = "cuneate", SearchString5 = "null", SearchString6 = "null", IconFileName = "oblanceolate.png" });
            //conn.Insert(new WoodySearch() { Characteristic = "LeafShape-Palmately", Name = "Palmately", Query = false, Column1 = "leafType", SearchString1 = "palmately", SearchString2 = "lobed", SearchString3 = "null", SearchString4 = "null", SearchString5 = "null", SearchString6 = "null", IconFileName = "Palmate.jpg" });
            //conn.Insert(new WoodySearch() { Characteristic = "LeafShape-Lobed", Name = "Lobed", Query = false, Column1 = "leafType", SearchString1 = "lobed", SearchString2 = "lyrate", SearchString3 = "null", SearchString4 = "null", SearchString5 = "null", SearchString6 = "null", IconFileName = "LobedCombined.jpg" });
            //conn.Insert(new WoodySearch() { Characteristic = "LeafShape-Pinnate", Name = "Pinnate", Query = false, Column1 = "leafType", SearchString1 = "pinnate", SearchString2 = "palmate", SearchString3 = "null", SearchString4 = "null", SearchString5 = "null", SearchString6 = "null", IconFileName = "PinnateCombined.jpg" });
            //TESTING END*********************************************************
            ...
            conn.Insert(new WoodySearch() { Characteristic = "FruitType-Acorn", Name = "Acorn", Query = false, Column1 = "familyCharacteristics", SearchString1 = "nut", SearchString2 = "nutlet", SearchString3 = "acorn", SearchString4 = "null", SearchString5 = "null", IconFileName = "Acorn.jpg" });
